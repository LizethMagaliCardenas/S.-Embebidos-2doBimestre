 ...
 * Codigo Knn para proyecto 2B
 */

#include "datos.h"

// datos de prueba
float datos_prueba [5]={910.82,26.60,933.61,6.3,2.0};

//cambio de variable
int respuesta;
int knn (int k, int etiquetas, int tam_col, int tam_fil); // definir la func

void setup() {
Serial.begin(9600);

respuesta=knn(3,3,5,87);
switch(respuesta){
  case 1:
    Serial.println("Posición Persona de pie");
  break;
  case 2:
    Serial.println("Posición Persona Sentada");
  break;
   case 3:
    Serial.println("Posición Persona acostada");
  break;
  }
}
